...
extern void ow_find_sensor(uint8_t *diff, uint8_t id[]);
extern void ow_setPin(uint8_t newpin);
extern uint8_t ow_search_sensors(int maxSensors, uint8_t *sensorDB);
